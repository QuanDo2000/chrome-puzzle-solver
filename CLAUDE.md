...
helpers (`hashFNV1a`, plus the solver layer's `emitGrid`, `cloneSolveResult`, `timeUp`, `lruSet`, `whiteConnectivity`, `trailPush`/`rollbackTrail`, `collectChangedCells`). Consumers `require('./shared.js')` (or
