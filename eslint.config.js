  ...
  // siblings (which are loaded together via manifest.content_scripts).
  {
    ...
    languageOptions: {
      ...
      globals: {
        ...
        nonogramCacheKey: 'readonly',
        binairoCacheKey: 'readonly',
        shikakuCacheKey: 'readonly',
        hashiCacheKey: 'readonly',
        yinYangCacheKey: 'readonly',
        slitherlinkCacheKey: 'readonly',
        heyawakeCacheKey: 'readonly',
        hitoriCacheKey: 'readonly',
        kakurasuCacheKey: 'readonly',
        kurodokoCacheKey: 'readonly',
        mosaicCacheKey: 'readonly',
        norinoriCacheKey: 'readonly',
        nurikabeCacheKey: 'readonly',
